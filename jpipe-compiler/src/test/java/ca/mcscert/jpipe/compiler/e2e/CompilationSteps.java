...
public class CompilationSteps {
	...
	public void theCompilationFailsWithASystemError() {
		assertThat(compilationError).isNotNull().isNotInstanceOf(CompilationException.class)
	...
	public void itHasConclusion(String id, String label) {
		assertThat(currentModel.conclusion()).isPresent().hasValueSatisfying(c -> {
	...
	public void itHasStrategy(String id, String label) {
		assertThat(currentModel.strategies()).extracting(JustificationElement::id, JustificationElement::label)
	...
	public void itHasEvidence(String id, String label) {
		assertThat(currentModel.evidence()).extracting(JustificationElement::id, JustificationElement::label)
				.contains(tuple(id, label));
	}

	@Then("the strategy {string} supports the conclusion {string}")
	public void strategySupportsConclusion(String strategyId, String conclusionId) {
