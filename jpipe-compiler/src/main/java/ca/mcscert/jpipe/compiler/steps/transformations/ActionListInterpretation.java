 ...
 */
public final class ActionListInterpretation extends Transformation<List<Command>, Unit> {

	@Override
	protected Unit run(List<Command> input, CompilationContext ctx) throws Exception {
